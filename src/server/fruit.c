...
static bool any_snake_occupies(const snake_t *snakes, const bool *slot_used, int snake_count, position_t p) {
...
bool fruit_handle_eating(world_t *w, snake_t *snakes, const bool *slot_used, int snake_count, fruit_state_t *fs) {
  bool eaten = false;
